...
activities = {
    ...
    "Tennis Club": {
        "description": "Learn and practice tennis techniques and participate in matches",
        "schedule": "Tuesdays and Thursdays, 3:30 PM - 5:00 PM",
        "max_participants": 10,
        "participants": ["james@mergington.edu"]
    },
    "Art Studio": {
        "description": "Painting, drawing, and sculpture techniques with professional instructors",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["isabella@mergington.edu"]
    },
    "Drama Club": {
        "description": "Theater performance and stage acting for school productions",
